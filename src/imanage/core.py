...
def dir_structure():
    ...
    if {jpg_dir_name, raw_dir_name} <= current_dirs:
        iCon = imageContainer(jpg_dir_name, raw_dir_name, retouch_dir_name)
    else:
...
class imageContainer:
    def __init__(self, jpg, raw, retouch=None):
        self.jpg_dir_path = os.path.abspath(os.path.join(os.getcwd(), jpg))
        self.raw_dir_path = os.path.abspath(os.path.join(os.getcwd(), raw))
        self.retouch_dir_path = os.path.abspath(os.path.join(os.getcwd(), retouch or retouch_dir_name))
